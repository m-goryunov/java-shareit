...
class UserControllerTest {
    ...
    void getAllUsers() throws Exception {
        when(userService.getAllUsers()).thenReturn(List.of(UserMapper.fromUserDto(userDto)));
    ...
    void saveNewUser() throws Exception {
        when(userService.createUser(any())).thenReturn(UserMapper.fromUserDto(userDto));
